...
export class Tab1Page {
  ...
  async sendToWhatsapp() {
    ...
    window.open(`https://api.whatsapp.com/send?phone=6285156097971&text=${output}`, '_blank');
  ...
  async sendToTelegram() {
    ...
    window.open(`https://t.me/Ptrmer?start=${output}`, '_blank');
  }
  ...
  async sendToEmail() {
    ...
    const url = `mailto:if21.putrimeriyana@mhs.ubpkarawang.ac.id?subject=Data&20Informasi&body=${output}`;
